...
""")
        ...
        with col_right:
            st.markdown("**👁 PDF preview** — scroll to browse all pages")
            # Embed PDF via base64 data URI in an iframe
            # height=700px shows roughly 1 full page; user can scroll inside
            pdf_embed = f"""
                <iframe
                ...
                >
                    ...
                    Please use the download button on the left.</p>
                </iframe>
            """
            st.components.v1.html(pdf_embed, height=720, scrolling=False)
